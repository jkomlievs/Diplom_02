...
public class Burger {
    ...
    public Bun bun;
    public List<org.example.Ingredient> ingredients = new ArrayList<>();
    ...
    public void addIngredient(org.example.Ingredient ingredient) {
    ...
    public float getPrice() {
        ...
        for (org.example.Ingredient ingredient : ingredients) {
